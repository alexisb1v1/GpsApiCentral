...
import { PayMultipleInfractionsHandler } from '@infraction/application/commands/v1/pay-multiple-infractions/handlers/pay-multiple-infractions.handler';
...
const Handlers = [
  ...
  PayInfractionHandler,
  PayMultipleInfractionsHandler,
  AnnulInfractionHandler,
  GetInfractionsHandler,
];
